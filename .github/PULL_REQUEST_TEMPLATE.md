...
## 🎯 Historia de usuario
Como **[rol]** quiero **[acción]** para **[beneficio]**.  Issue: closes #__
...
3. Verificar el criterio de aceptación
 
## 📸 Evidencias (capturas / GIF / salida de pruebas)
 
## 📋 Lista de chequeo del aprendiz
